        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlipHtmlUrl = table.Column<string>(type: "nvarchar(350)", maxLength: 350, nullable: true),
                    DirectorNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleTypeId = table.Column<byte>(type: "tinyint", nullable: false),
                    IssueId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contributions_RoleTypes_RoleTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contributions_RoleTypeId",
                table: "Contributions",
                column: "RoleTypeId");
